...
module.exports = {
	content: ["./app/**/*.{js,ts,jsx,tsx}", "./pages/**/*.{js,ts,jsx,tsx}", "./components/**/*.{js,ts,jsx,tsx}", "./assets/**/*.{js,ts,jsx,tsx}"],
	theme: {
		extend: {
			colors: {
				border: "#D2D2D2",
			...
			boxShadow: {
				...
				comp_lg: "-2px -2px 4px rgba(0, 0, 0, 0.08), 14px 10px 11px rgba(0, 0, 0, 0.05), 2px 2px 4px rgba(0, 0, 0, 0.1)",
