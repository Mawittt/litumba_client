...
export default function CulturalGroup(props : CulturalGroupsProps){
        const  {image, name , location , members ,} = useCulturalGroup(props)
     return (
        <div className="py-4 px-2 shadow-comp_lg rounded-lg">
            <div className='flex justify-between w-full'>
                <div className="flex gap-2 items-center">
                    <div><Image src={image} alt={"author avatar"} width={64} height={64} className={"h-[64px] object-cover rounded-md"} /></div>
                    <div >
