...
export default function useTopNavBar() {
    ...
    function getRoute() {
        ...
        else if (page.includes(ROUTES.jobs.update.replace("/", ""))) return "Jobs > Update"
        ...
        else if (page.includes(ROUTES.businesses.update.replace("/", ""))) return "Businesses > Update"
        ...
        else if (page.includes(ROUTES.market_place.products.update.replace("/", ""))) return "Products > Update"
        ...
        else if (page.includes((ROUTES.market_place.services.update.replace("/", "")))) return "Services > Update"
        ...
        else if (page.includes(ROUTES.cultural_groups.update.replace("/", ""))) return "Group > Update"
        ...
        else if (page.includes(ROUTES.real_estate.update.replace("/", ""))) return "R.E > Update"
