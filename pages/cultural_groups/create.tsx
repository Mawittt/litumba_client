...
export default function CulturalGroupCreation() {
    const { register, handleSubmit, createCulturalGroup, errors, cover, profile } = useCulturalGroupsCreate()
    return (
        <div className="shadow-comp_lg rounded-lg py-4 px-2 mx-2 flex flex-col gap-4">
            ...
            <Button label="Create group" onClick={handleSubmit(createCulturalGroup)} />
        </div>
    )
}