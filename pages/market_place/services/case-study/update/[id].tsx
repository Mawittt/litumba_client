...
export default function CaseStudyUpdate() {
    const { register, handleSubmit, errors, watch, updateCaseStudy, preview } = useCaseStudyUpdate()
    return (
        <div className="py-4 px-2 mt-4 rounded-lg shadow-comp_lg gap-4 flex flex-col">
            ...
            <Button label="update case study" onClick={handleSubmit(updateCaseStudy)} className="" full />
        </div>
    )
}