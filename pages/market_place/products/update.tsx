...
const ProductsUpdate = () => {
    const { previewServerImages, deleteServerImage, register, handleSubmit, errors, UpdateProduct, previewImages, deleteImage, mutator } = useProductUpdate()
    return (
        <div className="shadow-comp_lg rounded-lg py-4 px-2 mx-2 flex flex-col gap-4 mt-4">
            ...
            {mutator.isLoading ? <div className='flex justify-center'><Loader /></div> : <Button label="Update Product" onClick={handleSubmit(UpdateProduct)} />}
        </div>
    )
}
