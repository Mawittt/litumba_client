...
const ProductsCreate = () => {
    const {register, handleSubmit , errors , createProduct , previewImages , deleteImage} = useProductCreate()
  return (
    <div className="shadow-comp_lg rounded-lg py-4 px-2 mx-2 flex flex-col gap-4 mt-4">
            ...
            <Button label="Create Product" onClick={handleSubmit(createProduct)} />
        </div>
  )
}
