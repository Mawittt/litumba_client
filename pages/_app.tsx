...
function App({ Component, pageProps }: AppPropsWithLayout ) {
    ...
    return (
        <Provider store={store}>
            ...
            <div id='app' className={`overflow-hidden grid  h-[100vh]  grid-rows-[64px_auto_50px] sm:grid-cols-2 md:grid-rows-[auto auto] md:grid-cols-[auto_auto_auto] max-w-[2000px] m-auto border-solid border-border border-[1.5px]`}>
