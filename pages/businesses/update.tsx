...
import useBusinessUpdate from "../../pageUtils/useBusinessUpdate";
...
export default function BusinessUpdate() {
    const { register, handleSubmit, watch, updateBusiness, cover, logo , errors } = useBusinessUpdate()
    return (
        <div className="shadow-comp_lg rounded-lg py-4 px-2 mx-2 flex flex-col gap-4 mt-4">
            ...
            <div>
                ...
                <input type="file" id="logo" {...register("logo")} className="hidden" accept="image/*"  />
                {logo &&
            ...
            <div>
                ...
                <input type="file" id="cover" {...register("cover")} accept="image/*" className="hidden" />
                {cover &&
                    <div className="relative w-full aspect-square mt-4">
            ...
            <div className="flex flex-col gap-2">
                ...
                <select className="text-input p-0" {...register("niche", { required: "The niche is required" })} value={watch("niche")} >
                    <option value=""></option>
            ...
            <div className="flex flex-col gap-2">
                ...
                <input type="text" className="text-input" {...register("phone", { required: "The phone is required" })} value={watch("phone")} />
            ...
            <div className="flex flex-col gap-2">
                ...
                <input type="text" className="text-input" {...register("website")} value={watch("website")} />
                <ErrorMessage name="website" errors={errors} />
            </div>

            <Button label="Upload Business" onClick={handleSubmit(updateBusiness)} />
        </div>
    )
}